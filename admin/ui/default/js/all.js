...
function loadDivContent(index, url) {
    $("#"+index).html(busyImage + '<div id="loadingprogressbanner"></div>');
    $("#"+index).load(url);
}
...
//  $("#processqueueoutput").html('Processing queue, please wait<script type="text/javascript">alert(document.location)</script>');
    ...
    if (typeof asyncLoad != 'undefined') {
        alert("loading divs");
        ayncLoad.forEach(loadDivContent)
    }
});
...
/*phpList3/public_html/lists/admin/ui/default/js/jquery.tablednd.js*/ /**
